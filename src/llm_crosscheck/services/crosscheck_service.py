    ...
    async def validate_response(
        ...
        try:
            ...
            results = {
                ...
                "token_usage": {
                    "prompt_tokens": validation_response.usage.prompt_tokens if validation_response.usage else None,
                    "completion_tokens": validation_response.usage.completion_tokens if validation_response.usage else None,
                    "total_tokens": validation_response.usage.total_tokens if validation_response.usage else None,
                },
            }
